...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [0] = LAYOUT( \
        KC_LGUI, KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,KC_EQL, KC_BSLS,KC_GRV, MT(MOD_RGUI, KC_PSCR), \
        ...
        KC_LSPO,XXXXXXX,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_RSPC,     KC_UP,  KC_PGDN,\
        KC_LCTL,KC_MENU,KC_LALT,               KC_SPC,           KC_RALT,TT(1),  XXXXXXX,     KC_LEFT,KC_DOWN,MT(MOD_RCTL,KC_RIGHT) \
    ),
    [1] = LAYOUT( \
        ...
        KC_CAPS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_LEFT,KC_DOWN,KC_UP,KC_RIGHT,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,     KC_VOLU,\
